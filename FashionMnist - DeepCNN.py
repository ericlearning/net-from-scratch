...
DIR = os.path.dirname(os.path.abspath(__file__)) + '/SavedNetwork/FashionMnistCNN_Deep/'
...
trainer = Trainer(network, X_train, Y_train, X_val, Y_val, num_epoch, minibatch_size, optimizer_type, {'lr' : learning_rate}, verbose = True, LossAccInterval = 400)
