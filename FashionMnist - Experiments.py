...
DIR = os.path.dirname(os.path.abspath(__file__)) + '/SavedNetwork/FashionMnist_experimental/'
...
trainer = Trainer(network, X_train, Y_train, X_val, Y_val, num_epoch, minibatch_size, optimizer_type, {'lr' : learning_rate}, verbose = True, LossAccInterval = 20, lr_scheduler_type = 'exp_decay', lr_scheduler_params = {'k' : 0.0001})
